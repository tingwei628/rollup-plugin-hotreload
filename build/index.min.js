  ...
  return {
    ...
    onwrite: function onwrite(opts) {
      ...
      if (!isCopyFilePathToHotreloadJs) {
        ...
        fs.createReadStream(path.join(__dirname, "./build/hotreload.min.js")).pipe(copyTransform).pipe(fs.createWriteStream(path.join(__dirname, "./" + rootDir + "/build/hotreload.min.js")));
