(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('crypto'), require('fs'), require('path'), require('stream'), require('http')) :
	typeof define === 'function' && define.amd ? define(['exports', 'crypto', 'fs', 'path', 'stream', 'http'], factory) :
	(factory((global['rollup-plugin-hotreload'] = {}),global.crypto,global.fs,global.path,global.stream,global.http));
}(this, (function (exports,crypto,fs,path,stream,http) { 'use strict';
  ...
  return {
    ...
    onwrite: function onwrite(opts) {
      ...
      if (!isCopyFilePathToHotreloadJs) {
        ...
        rs.pipe(copyTransform).pipe(fs.createWriteStream(rootDir + "/hotreload.min.js"));

        isCopyFilePathToHotreloadJs = true;
      }

      fs.readFile(options.templateHtmlPath, "utf8", function (err, htmlString) {
        if (err) throw err;
        /*
        ...
        */
        ...
        fs.writeFile("./" + rootDir + "/index.html", newHtmlString, function (err) {
          if (err) throw err;
        });
      });
    }
